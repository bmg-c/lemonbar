...
dwm-msg --ignore-reply subscribe tag_change_event |
    ...
    lemonbar -d -g "1225x$barheight+380+$gappx" \
             -o HDMI-A-0 -f "Font Awesome 5 Free:size=7:style=solid" \
             -B "$base01" -F "$base05" &
...
dwm-msg --ignore-reply subscribe client_focus_change_event |
    ...
    lemonbar -d -g "400x$barheight+$gappx+$gappx" \
             -o HDMI-A-0 -f "RobotoMono Nerd Font:size=9:weight=200" \
             -B "$base01" -F "$base05" &
...
do
    ...
    lemonbar -d -g "80x$barheight+$((width - 100 - 70))+$gappx" \
             -o HDMI-A-0 -f "RobotoMono Nerd Font:size=9:weight=200" \
             -B "$base01" -F "$base05" &
